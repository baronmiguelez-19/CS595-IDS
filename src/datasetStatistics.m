...
%
% Input:   -inputDataset: table with the dataset data to be prepared
% Outputs: -outputDataset: table with the dataset prepared (labeled and extra
%                         columns for training and testing)
%          -Database Shape: statistics of the database displayed in the
%          workspace.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Load dataset that will be used to train (table format, not labeled)
inputDataset = 'NSLtestDatabase.mat';
load(inputDataset);
data = NSLtestdatabase;
clear NSLtestDatabase;
...
%Create output dataset prepared for training/testing
outputDataset = data;
...
%Display Results
disp('DATASET SHAPE')
str=['Normal: ', num2str(percentNormal), newline, 'Attack: ', num2str(percentAttack), newline, newline, 'DOS: ', num2str(percentDOS), newline, 'U2R: ', num2str(percentU2R), newline, 'R2L: ', num2str(percentR2L), newline, 'PROBE: ', num2str(percentPROBE)];
disp(str);
